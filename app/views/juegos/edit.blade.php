	...
	<div class="col-sm-12">
		<section class="panel panel-default">
			...
			<div class="panel-body">
				...
				{{ Form::open(array('url' => URL::to('/juegos/' . $juego->id), 'method' => 'PUT', 'class' => 'panel-body wrapper-lg')) }}

				<div class="row">
					<div class="col-xs-3">
						<label>Juego</label>
						{{ Form::select( 'cartons_id', Carton::All()->
						lists('carton', 'id'), $juego->cartons_id, array( "placeholder" => "", 'class' => 'form-control input-lg')) }}
					</div>
					...
					<div class="col-xs-3">
						<label>Sorteo</label>
						{{ Form::text('sorteo', $juego->sorteo, array('class' => 'form-control input-lg', 'id' =>'sorteo', 'placeholder' => '')) }}
				...
				<div class="row">
					...
					<div class="col-xs-3">
						...
						{{ Form::text('entregados', $juego->entregados, array('class' => 'form-control input-lg', 'id' =>'entregados', 'name' =>'entregados', 'placeholder' => '')) }}
					...
					<div class="col-xs-3">
						...
						{{ Form::text('devolucion', $juego->devolucion, array('class' => 'form-control input-lg ', 'id' =>'devolucion', 'name' =>'devolucion', 'placeholder' => '')) }}
