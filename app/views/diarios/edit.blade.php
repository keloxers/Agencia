	...
	<div class="col-sm-12">
		<section class="panel panel-default">
			...
			<div class="panel-body">
				{{ Form::open(array('url' => URL::to('/diarios/' . $diario->id), 'method' => 'PUT', 'class' => 'panel-body wrapper-lg')) }}
				...
				<div class="row">
					<div class="col-xs-3">
						...
						lists('cuenta', 'id'), $cuenta->cuenta, array( "placeholder" => "", 'class' => 'form-control input-lg')) }}
					</div>

					<div class="col-xs-3">
						<label>Importe</label>
						{{ Form::text('importe', $diario->importe, array('class' => 'form-control input-lg', 'id' =>'importe', 'name' => 'importe','placeholder' => '')) }}
					...
					<div class="col-xs-3">
						<label>Tipo</label>
						{{ Form::select('tipo', array('debe' => 'debe', 'ingreso' => 'haber'), $diario->tipo, array('class' => 'form-control input-lg', 'id' =>'tipo')) }}
					</div>
				...
				<div class="row">
					...
					<div class="col-xs-9">
						...
						{{ Form::text('descripcion', $diario->descripcion, array('class' => 'form-control input-lg', 'id' =>'descripcion', 'name' =>'descripcion', 'placeholder' => '')) }}
